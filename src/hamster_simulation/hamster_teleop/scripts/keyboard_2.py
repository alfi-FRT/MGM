...
class AckermannDriveKeyop:
    def __init__(self):
        ...
        self.cmd_topic = rospy.get_param('~topic','/agent2/ackermann_cmd')
        self.shooting_topic = rospy.get_param('~shooting_topic','/agent2/shooting')
        self.frame = rospy.get_param('~frame','agent2/base_link')
    ...
    def print_state(self):
        ...
        rospy.loginfo('\x1b[1M\rUse w-a-s-d to change speed and steering angle')
        rospy.loginfo('\x1b[1M\rUse space to brake and tab to align wheels')
        rospy.loginfo('\x1b[1M\rUse e to shoot')
