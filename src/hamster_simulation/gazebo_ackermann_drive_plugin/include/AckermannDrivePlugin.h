...
private:
    ...
    /**
     * @brief Odometry ground truth ros topic publisher 
     */

    ros::Publisher gtPublisher_;
    ...
    double xPoseAccumulateError_ = 0.0;
    double yPoseAccumulateError_ = 0.0;
    double yawAccumulateError_ = 0.0;
    
    double xVelAccumulateError_ = 0.0;
    double yVelAccumulateError_ = 0.0;
    double zVelAccumulateError_ = 0.0;
    
    double xAngVelAccumulateError_ = 0.0;
    double yAngVelAccumulateError_ = 0.0;
    double zAngVelAccumulateError_ = 0.0;
    ...
    bool is_tfBroadcasting_;
    bool is_tf_gt = false;
    bool is_tf_odom = false;
